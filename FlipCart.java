...
public static String validateAndRegister(long mobileNumber,String fullName,String userName){

	
	System.out.println("validateAndRegister method is started");
	String registerstatus=null;
	if(mobileNumber !=0 &&  fullName !=null && userName !=null){
		
		if( fullName.length()>4 && userName.length()>4){
			
			registerstatus="thank you "+fullName+"registered successfully";
		}else{
			registerstatus="please check the fullName,userName";
		}
